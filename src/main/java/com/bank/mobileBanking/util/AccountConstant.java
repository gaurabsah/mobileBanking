...
public class AccountConstant {
    ...
    public static final String INSERT_ACCOUNT_DETAIL = "INSERT into account_tbl ( account_number,account_type, bank_balance, security_pin, bank_id, user_id) VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public static final String GET_ACCOUNT_DETAIL = "SELECT a.account_number,account_type, a.bank_balance, a.security_pin, \n" +
